...
const translations = {
  en: {
    ...
    btnOcrTitle: 'Recognize text on the current page (choose the language at left)',
  ...
  km: {
    ...
    btnOcr: 'ស្គាល់ទំព័រ',
    btnOcrTitle: 'ស្គាល់អត្ថបទលើទំព័របច្ចុប្បន្ន (ជ្រើសរើសភាសានៅខាងឆ្វេង)',
