...
const translations = {
  en: {
    ...
    zoomResetTitle: 'Reset zoom to 200%',
    zoomInTitle: 'Zoom in',
    ...
    btnExport: 'Save PDF',
    btnExportTitle: 'Save the modified PDF — choose a filename, output size, and where to save it',
    btnFeatures: '✨ Features',
    btnFeaturesTitle: 'See what this app can do',

    saveModalTitle: 'Save PDF',
    saveFilenameLabel: 'File name',
    savePickerUnsupported: "Your browser doesn't support choosing a save location here, so Save downloads to your default downloads folder instead.",
    saveChooseLocation: 'Choose location…',
    saveChooseLocationTitle: 'Pick the exact folder and filename to save to',
    saveConfirm: 'Save',
    saveConfirmTitle: "Save to your browser's default downloads folder",
    ...
    sigStyleBrush: 'Brush',
    sigSwatchesTitle: 'Preset signature colors',
    sigUndoTitle: 'Undo last stroke',
    sigRedoTitle: 'Redo',
    sigClear: 'Clear',
    ...
    drawFillLabel: 'Fill',
    drawSwatchesTitle: 'Preset highlighter colors',
    swatchYellow: 'Yellow',
    swatchGreen: 'Green',
    swatchBlue: 'Blue',
    swatchPink: 'Pink',
  ...
  km: {
    ...
    btnUndoTitle: 'មិនធ្វើវិញ',
    btnRedoTitle: 'ធ្វើវិញ',
    viewModeTitle: 'របៀបមើលទំព័រ',
    viewContinuous: 'បន្តបន្ទាប់',
    viewSingle: 'ទំព័រតែមួយ',
    viewDouble: 'ទំព័រពីរ',
    zoomOutTitle: 'បង្រួម',
    zoomResetTitle: 'កំណត់ការពង្រីកទៅ 200% វិញ',
    zoomInTitle: 'ពង្រីក',
    ...
    btnExportTitle: 'រក្សាទុកឯកសារ PDF ដែលបានកែប្រែ — ជ្រើសរើសឈ្មោះឯកសារ ទំហំលទ្ធផល និងទីតាំងរក្សាទុក',
    btnFeatures: '✨ លក្ខណៈពិសេស',
    btnFeaturesTitle: 'មើលអ្វីដែលកម្មវិធីនេះអាចធ្វើបាន',

    saveModalTitle: 'រក្សាទុក PDF',
    saveFilenameLabel: 'ឈ្មោះឯកសារ',
    savePickerUnsupported: 'កម្មវិធីរុករករបស់អ្នកមិនអាចជ្រើសរើសទីតាំងរក្សាទុកនៅទីនេះទេ ដូច្នេះការរក្សាទុកនឹងទាញយកទៅថតទាញយកលំនាំដើមរបស់អ្នកវិញ។',
    saveChooseLocation: 'ជ្រើសរើសទីតាំង…',
    saveChooseLocationTitle: 'ជ្រើសរើសថត និងឈ្មោះឯកសារច្បាស់លាស់ដែលត្រូវរក្សាទុក',
    saveConfirm: 'រក្សាទុក',
    saveConfirmTitle: 'រក្សាទុកទៅថតទាញយកលំនាំដើមរបស់កម្មវិធីរុករករបស់អ្នក',
    ...
    sigStyleBrush: 'ជក់',
    sigSwatchesTitle: 'ពណ៌ហត្ថលេខាដែលបានកំណត់ជាមុន',
    sigUndoTitle: 'មិនធ្វើខ្សែគូរចុងក្រោយវិញ',
    sigRedoTitle: 'ធ្វើវិញ',
    sigClear: 'សម្អាត',
    ...
    drawSwatchesTitle: 'ពណ៌សញ្ញាសម្គាល់ដែលបានកំណត់ជាមុន',
    swatchYellow: 'លឿង',
    swatchGreen: 'បៃតង',
    swatchBlue: 'ខៀវ',
    swatchPink: 'ផ្កាឈូក',
    swatchOrange: 'ទឹកក្រូច',
    swatchPurple: 'ស្វាយ',
    swatchBlack: 'ខ្មៅ',
    swatchRed: 'ក្រហម',
